<?php
if (isset($_POST['btn'])) {
    $obj_appointment->save_appointment_old($_POST);
}
?>
...
//                    alert(xmlhttp.status);
        ...
        xmlhttp.open("GET", "view/page/ajax/appointment_details.php?get_time_slot_id=" + val3, true);
        xmlhttp.send();
    }
...
//                    alert(xmlhttp.status);
        ...
        xmlhttp.open("GET", "view/page/ajax/appointment_details.php?patient_reg_id=" + val4, true);
        xmlhttp.send();
    }

...
$obj_login = new Login();
    if(isset($_POST['btn_doctor'])){
        $obj_login->check_doctor_login($_POST);
    }
?>
<!DOCTYPE html>
<html>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Sign as <mark>Doctor</mark></p>
        <form action="" method="post">
          ...
          <div class="form-group has-feedback">
              <input type="email" name="doctor_email_address" class="form-control" placeholder="Email" />
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
                <button type="submit" name="btn_doctor" class="btn btn-primary btn-block btn-flat">Sign In</button>
            </div><!-- /.col -->
          </div>
        </form>

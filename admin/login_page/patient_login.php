...
$obj_login = new Login();
    if(isset($_POST['btn_patient'])){
        $obj_login->check_patient_login($_POST);
    }
?>
<!DOCTYPE html>
<html>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Sign as <mark>Patient</mark></p>
        <form action="" method="post">
          ...
          <div class="form-group has-feedback">
              <input type="email" name="patient_email_address" class="form-control" placeholder="Email" />
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
              <input type="password" name="patient_password" class="form-control" placeholder="Password" />
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
                <button type="submit" name="btn_patient" class="btn btn-primary btn-block btn-flat">Sign In</button>
            </div><!-- /.col -->
          </div>
        </form>

...
$obj_login = new Login();
    if(isset($_POST['btn_reg_manager'])){
        $obj_login->check_appointment_manager_login($_POST);
    }
?>
<!DOCTYPE html>
<html>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Sign as <mark>Appointment Manager</mark></p>
        <form action="" method="post">
          ...
          <div class="form-group has-feedback">
              <input type="email" name="app_manager_email_address" class="form-control" placeholder="Email" />
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
              <input type="password" name="app_manager_password" class="form-control" placeholder="Password" />

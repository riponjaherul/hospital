...
if ($_GET['pnid']) {
    ...
    <section class="invoice">
        <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
                <?php
                $doctor_id = $obj_doctor->get_doctor_id_nurse_pres_id($pres_nurse_id);
    ...
    <?php echo $doctor_info['doctor_qualification']; ?><br>
            ...
            <div class="col-sm-4 invoice-col">
                ...
                $patient_info = $obj_patient->get_patient_info_patient_id($patient_id['patient_id']);
                ?>
                Date : 
                <address>
                    <strong style="font-size: 18px;"><?php echo $patient_info['patient_name']; ?></strong><br>
                    ID : <?php echo $patient_info['patient_reg_id']; ?><br>
                    Sex : <?php echo $patient_info['patient_gender']; ?><br>
                </address>
            </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
            <?php
            $doctor_pres_info = $obj_doctor->get_doctor_pres_info($pres_nurse_id);
            ?>
    ...
    <?php echo $doctor_pres_info['patient_history']; ?>
        ...
        <div class="row">
            <?php
            $pres_nurse_info = $obj_nurse->get_nurse_pres_info($pres_nurse_id);
            ?>
            <!-- accepted payments column -->
            <div class="col-xs-3">
        ...
        if ($doctor_pres_info['test_status'] == 1) {
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <ol>
                        <?php
                        $all_test = $obj_admin->get_all_test($pres_nurse_id);
